...
function findSupportResponse(query) {
  ...
  var patterns = [
    ...
    { keys: ["ubicacion", "ubicación", "donde", "dónde", "dirección"], resp: "Estamos ubicados en Llano Bonito, Ciudad de Panamá, justo al lado de la estación Puma. ¡Fácil acceso y estacionamiento!" },
